                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    >
                                        Premium door lock with a slider locking
                                        system and an innovative cylinder lock
                                        mechanism
                                    </p>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        >
                                            The{" "}
                                            <strong>Door Lock Aldrop</strong> is
                                            manufactured using{" "}
                                            <strong>high-quality steel</strong>,
                                            ensuring strength, durability, and
                                            long-term performance. Designed for
                                            secure locking while maintaining
                                            smooth operation.
                                        </p>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            that provides firm grip and reliable
                                            daily usage.
                                        </p>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            Fitted with a{" "}
                                            <strong>
                                                new innovative cylinder lock
                                            </strong>{" "}
                                            ensuring smooth key operation and
                                            enhanced security. Suitable for both
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            , the Door Lock Aldrop delivers
                                            consistently smooth performance with
                                            minimal wear. Engineered for a{" "}
                                            <strong>
                                                long operational life
                                            </strong>
                                            , it maintains reliable locking
                                            strength even after years of
                                            frequent use.
                                        </p>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            Door Lock Aldrop is manufactured
                                            using all high-quality premium
                                            metals.
                                        </p>
                                    </div>
                                </div>
